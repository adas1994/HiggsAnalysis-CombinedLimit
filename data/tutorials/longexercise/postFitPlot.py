...
parser.add_argument("--extratags", dest="extratags", nargs="*", default=[])
...
if extratag != "" :
    canvas.SaveAs("plot_%s_%s_%s.png" % (first_dir, second_dir, extratag))
    canvas.SaveAs("plot_%s_%s_%s.pdf" % (first_dir, second_dir, extratag))
else:
